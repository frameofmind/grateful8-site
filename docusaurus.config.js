...
const config = {
  ...
  projectName: 'grateful8-site', // Usually your repo name.
  presets: [
    [
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/frameofmind',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Grateful8, Ltd.`,
      },
      prism: {
